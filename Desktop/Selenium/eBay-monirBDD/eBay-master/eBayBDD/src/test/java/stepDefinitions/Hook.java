...
public class Hook extends CommonAPI {
    ...
    public  void initializeTest() {
        ...
        if(getOsNameFromSystem.contains("Mac")){
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\Moniruzzaman Miah\\Desktop\\Selenium\\eBay-monirBDD\\eBay-master\\eBayBDD\\driver\\chromedriver");
        }else if(getOsNameFromSystem.contains("Windows")){
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\Moniruzzaman Miah\\Desktop\\Selenium\\eBay-monirBDD\\eBay-master\\eBayBDD\\driver\\chromedriver.exe");
        }
